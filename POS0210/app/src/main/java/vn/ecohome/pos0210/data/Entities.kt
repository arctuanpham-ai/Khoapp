...
@Entity data class MonthlyAccountingEntity(@PrimaryKey val monthKey:String,val cogs:Long?=null,val cogsSource:String="UNAVAILABLE",val openingCash:Long=0,val reserveBasisPoints:Int=1000,val openingCashOverridden:Boolean=false,val closingCashSnapshot:Long?=null)
...
@Entity(indices=[Index("occurredAt"),Index("type"),Index("partnerId")]) data class FinancialMovementEntity(@PrimaryKey val id:String,val type:String,val amount:Long,val occurredAt:Long,val partnerId:String?=null,val method:String="CASH",val note:String="")
