...
@Entity data class EmployeeEntity(@PrimaryKey val id:String,val name:String,val active:Boolean=true,val pin:String="0000",val role:String="STAFF",val canCheckout:Boolean=true,val canPurchase:Boolean=false)
...
@Entity(indices=[Index("supplierId")]) data class PurchaseEntity(@PrimaryKey val id:String,val supplierId:String?,val enteredBy:String,val purchasedAt:Long,val total:Long,val note:String="")
@Entity(indices=[Index("purchaseId")]) data class PurchaseItemEntity(@PrimaryKey val id:String,val purchaseId:String,val name:String,val qty:Double,val unit:String,val unitPrice:Long,val amount:Long)
