...
@Entity data class MonthlyAccountingEntity(@PrimaryKey val monthKey:String,val cogs:Long?=null,val cogsSource:String="UNAVAILABLE",val openingCash:Long=0,val reserveBasisPoints:Int=1000)
