...
abstract class PosDatabase:RoomDatabase(){abstract fun dao():PosDao;companion object{@Volatile private var instance:PosDatabase?=null;fun get(context:Context):PosDatabase=instance?:synchronized(this){instance?:Room.databaseBuilder(context.applicationContext,PosDatabase::class.java,"pos0210.db").build().also{instance=it}}}}
